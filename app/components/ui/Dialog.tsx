...
export const DialogDescription = memo(({ className, children, ...props }: RadixDialog.DialogDescriptionProps) => {
  return (
    <RadixDialog.Description
      className={classNames('text-xs text-bolt-elements-textSecondary mt-0.5', className)}
      {...props}
    >
      {children}
    </RadixDialog.Description>
  ...
  return (
    <RadixDialog.Portal>
      ...
      <RadixDialog.Content asChild>
        <motion.div
          className={classNames(
            'fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-950 rounded-lg shadow-xl border border-bolt-elements-borderColor z-[9999] w-[420px] focus:outline-none',
            className,
          )}
          initial="closed"
          animate="open"
